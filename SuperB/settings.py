...
INSTALLED_APPS = [
    ...
    'rest_framework_cache', # to use redis cache timeout
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "SuperB.context-processor.extras",
            ],
        },
    },
]
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "User.api.serializers.CustomTokenObtainSerializer",
    "JTI_CLAIM": "jti",
